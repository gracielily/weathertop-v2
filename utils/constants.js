...
const openMapWeatherTopMapping = {
  // openMap weather codes taken from https://openweathermap.org/weather-conditions
  100: [800], // Clear
...
module.exports = {
  ...
  OPEN_MAP_WEATHERTOP_MAPPING: openMapWeatherTopMapping
};
